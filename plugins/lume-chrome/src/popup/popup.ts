...
export interface PopupViewModel {
  ...
  permissionCards: PopupCard[];
  capabilityCards: PopupCard[];
  detailsText: string;
}

export function buildPopupViewModel(rawStatus: any): PopupViewModel {
  ...
  const tone: PopupTone = connected ? "ok" : status === "reconnecting" ? "warn" : "error";
...
function render(model: PopupViewModel): void {
...
function renderCards(id: string, cards: PopupCard[]): void {
